...
export default function More() {
    const arrowPosition = (e) => {
        ...
        if (svg.classList.contains('-rotate-180')) {
            svg.classList.remove('-rotate-180', 'text-[#1d9bf0]');
            svg.classList.add('rotate-0', 'text-white');
        } else {
            svg.classList.add('-rotate-180', 'text-[#1d9bf0]', 'transition-all');
            svg.classList.remove('rotate-0', 'text-white');
        }
    }
